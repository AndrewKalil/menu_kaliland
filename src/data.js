const menu = [
    ...
    },
    {
        ...
        price: '5.500',
        tipos: [
            {name: 'frutos rojos', img: './images/malteada-frutos-rojos.jpeg'},
            {name: 'guanabana', img: './images/malteada-guanabana.jpg'},
            {name: 'cafe con arequipe', img: './images/malteada-cafe.jpg'},
            {name: 'chocolate', img: './images/malteada-chocolate.jpg'},
        ]
        ,
    ...
    },
    {
        ...
        tipos: [
            ...
            {name: 'Pizza de pollo y queso', price: "14.000"},
            {name: 'Pizza de bocadillo y queso', price: "13.000"},
            {name: 'Pizza de ajo, cebolla y queso', price: "13.000"},
            {name: 'Pizza de salami y maiz', price: "13.000"},
            {name: 'Pizza de jamon y maiz', price: "13.000"},
            {name: 'Pizza de pollo y maiz', price: "13.000"},
            {name: 'Pizza de pollo y champiñones', price: "14.000"},
            {name: 'Pizza de salami y champiñones', price: "13.000"},
            {name: 'Pizza de jamon y champiñones', price: "13.000"},
            {name: 'Pizza tres carnes (Pollo, Jamon, Salami)', price: "14.500"},
            {name: 'Pizza Hawaiana', price: "13.000"},
            {name: 'Pizza Hawaiana especial (con pollo)', price: "14.000"},
            {name: 'Queso y salami', price: "13.000"},
        ],
